...
export default function PricingPage() {
      ...
      return (
        <div className="text-center">
          <button 
            ...
            className="bg-purple-600 text-white py-3 px-8 rounded-lg font-semibold hover:bg-purple-700 transition-colors shadow-lg"
          >
    ...
    if (recommendedPlan) {
      return (
        <div className="bg-white p-8 rounded-xl shadow-lg">
          <h3 className="text-2xl font-bold text-purple-900 mb-4">Your Recommendation</h3>
              ...
              <div className="bg-purple-50 p-4 rounded-lg mb-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <FaCheck className="text-purple-600 mr-2 mt-1 flex-shrink-0" />
    ...
    return (
      <div className="bg-white p-8 rounded-xl shadow-lg">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-bold text-purple-900">Question {currentQuestion + 1} of {questions.length}</h3>
          <div className="flex gap-1">
            {questions.map((_, index) => (
              <div 
                key={index} 
                className={`h-2 w-8 rounded-full ${index <= currentQuestion ? 'bg-purple-600' : 'bg-gray-200'}`}
              ></div>
            ))}
          </div>
        </div>
        ...
        <div className="space-y-3">
          {questions[currentQuestion].options.map((option, index) => (
            <button
              ...
              className="w-full text-left p-4 rounded-lg border border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-colors flex justify-between items-center"
            >
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative py-20 bg-purple-50">
        <div className="container mx-auto px-4 relative z-10 text-center">
          <Link href="/" className="inline-block mb-8">
            <img 
              src="/hudson-logo-circle.svg" 
              alt="Hudson Virtual" 
              className="h-16 w-16 mx-auto"
            />
          </Link>
          <h1 className="text-5xl font-bold text-purple-900 mb-6">Simple, Transparent Pricing</h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-white rounded-xl shadow-lg overflow-hidden border border-purple-500 relative"
            >
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-100 to-blue-100">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-purple-900 mb-4">Not Sure Which Plan Is Right For You?</h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-purple-900 mb-4">Administrative Support</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-purple-900 mb-4">Business Operations</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-purple-900 mb-4">Project Support</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-purple-900 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            href="/contact"
            className="inline-block bg-white text-purple-900 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-100 transition-colors shadow-lg"
          >
            Book Your Free Call
          </Link>
        </div>

...
const clientTypes = [
  ...
  { icon: <FaHeart className="text-brand-purple text-2xl mb-2" />, label: 'Mission-Driven Organizations' },
];
    ...
    <main className="min-h-screen bg-gray-50 pb-20">
      ...
      <section className="w-full py-16 px-4 text-center bg-gradient-to-r from-brand-navy to-brand-purple text-white relative overflow-hidden pt-44">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Meet Natasha – Your Admin Unicorn</h1>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-semibold text-brand-navy mb-8 text-center">Why Work With Me?</h2>

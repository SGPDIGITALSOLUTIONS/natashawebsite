      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions about our virtual assistant services? We're here to help. 
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">nastasha@hudsonvirtual.co.uk</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">+44 123 456 7890</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/company/hudsonvirtual" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600">

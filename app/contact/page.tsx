            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-2 bg-purple-600 text-white p-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.instagram.com/hudsonvirtual" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-200 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://twitter.com/hudsonvirtual" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-200 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">

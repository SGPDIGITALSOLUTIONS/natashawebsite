              ...
              <div className="md:col-span-2 bg-purple-600 text-white p-8">
                ...
                <div className="space-y-4 mb-8">
                  <p className="flex items-center">
                    ...
                    <span>contact@hudsonvirtual.com</span>
                  </p>
                  <p className="flex items-center">
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="md:col-span-3 p-8">
                {formState.submitted ? (
                  ...
                  >
                    ...
                    <button
                      onClick={() => setFormState(prev => ({ ...prev, submitted: false, name: '', email: '', phone: '', company: '', message: '' }))}
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 bg-purple-600 text-white rounded-md font-medium hover:bg-purple-700 transition-colors ${formState.loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
